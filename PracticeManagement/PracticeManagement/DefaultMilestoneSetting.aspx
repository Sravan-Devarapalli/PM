<%@ Page Title="" Language="C#" MasterPageFile="~/PracticeManagementMain.Master"
    AutoEventWireup="true" CodeBehind="DefaultMilestoneSetting.aspx.cs" Inherits="PraticeManagement.DefaultMilestoneSetting" %>
...
<asp:Content ID="cntTitle" ContentPlaceHolderID="title" runat="server">
    <title>Default Milestone Setting | Practice Management</title>
</asp:Content>
<asp:Content ID="cntHeader" ContentPlaceHolderID="header" runat="server">
    Default Milestone Setting
</asp:Content>
        ...
        <table border="0" cellpadding="3" cellspacing="3" width="700px">
            <tr>
                ...
                <td style="padding-left: 5px; padding-right: 5px;">
                    ...
                    <asp:CustomValidator ID="cvClients" runat="server" ControlToValidate="ddlClients"
                ...
                <td style="padding-left: 5px; padding-right: 5px;">
                    ...
                    <asp:CustomValidator ID="cvProjects" runat="server" ControlToValidate="ddlProjects"
                ...
                <td style="padding-left: 5px; padding-right: 5px;">
                    ...
                    <asp:CustomValidator ID="cvMileStones" runat="server" ControlToValidate="ddlMileStones"
            ...
            <tr>
                <td colspan="9" style="padding-top: 20px;">
                    ...
                    <asp:ValidationSummary ID="vsMilestone" runat="server" />
            ...
            <tr>
                ...
                <td align="center" style="padding-top: 10px;">
                    <asp:Button ID="btnSave" runat="server" Text="Save Milestone" OnClick="btnSave_Click" />
