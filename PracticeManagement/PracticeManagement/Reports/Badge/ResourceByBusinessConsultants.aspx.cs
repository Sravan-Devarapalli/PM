...
{
    public partial class ResourceByBusinessConsultants : System.Web.UI.Page
    {
        ...
        private void UpdateChartTitle()
        {
            ...
            title.Text = title.ToolTip = "Available Resources by Business Level";
        ...
        public void GenerateExcel()
        {
            ...
            if (TitleList.Count > 0)
            {
                string dateRangeTitle = string.Format("Available Resource by Business Consultants report for the period: {0} to {1}", dtpStart.DateValue.ToString(Constants.Formatting.EntryDateFormat), dtpEnd.DateValue.ToString(Constants.Formatting.EntryDateFormat));
                ...
                dataset.DataSetName = "AvailableResourceByBusinessConsultants";
