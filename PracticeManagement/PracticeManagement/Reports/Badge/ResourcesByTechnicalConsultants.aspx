<%@ Page Title="Available Resources by Technical Level" Language="C#" MasterPageFile="~/PracticeManagementMain.Master"
    AutoEventWireup="true" CodeBehind="ResourcesByTechnicalConsultants.aspx.cs" Inherits="PraticeManagement.Reports.Badge.ResourcesByTechnicalConsultants" %>
    ...
    <asp:UpdatePanel ID="upnlBody" runat="server">
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlFilters" runat="server" CssClass="bgColor_d4dff8" Style="padding: 10px;
                padding-left: 50px;">
                <uc:Filter ID="filter" runat="server" ddlType="3" />
            </asp:Panel>
            ...
            <div id="divEmptyMessage" class="MSBadgeEmptyDiv font14PxImp" style="display: none;"
                runat="server">
                There are no technical consultants for the filters selected.
            </div>
        </ContentTemplate>
        <Triggers>
