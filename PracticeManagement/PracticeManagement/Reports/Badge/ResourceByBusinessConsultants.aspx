<%@ Page Title="Available Resources by Business Level" Language="C#" MasterPageFile="~/PracticeManagementMain.Master"
    AutoEventWireup="true" CodeBehind="ResourceByBusinessConsultants.aspx.cs" Inherits="PraticeManagement.Reports.Badge.ResourceByBusinessConsultants" %>
    ...
    <asp:UpdatePanel ID="upnlBody" runat="server">
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlFilters" runat="server" CssClass="bgColor_d4dff8" Style="padding: 10px;
                padding-left: 50px;">
                <uc:Filter ID="filter" runat="server" ddlType="2" />
            </asp:Panel>
            ...
            <div id="divWholePage" runat="server" style="display: none">
             ...
             <div id="divEmptyMessage" class="MSBadgeEmptyDiv font14PxImp" style="display: none;" runat="server">
                There are no business consultants for the filters selected.
            </div>
        </ContentTemplate>
        <Triggers>
