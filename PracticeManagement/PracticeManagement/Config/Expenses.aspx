<%@ Page Title="" Language="C#" MasterPageFile="~/PracticeManagementMain.Master"
    AutoEventWireup="true" CodeBehind="Expenses.aspx.cs" Inherits="PraticeManagement.Config.Expenses" %>
                        ...
                        <ContentTemplate>
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <asp:CustomValidator ID="custPeriod" runat="server" ErrorMessage="The Period Start must be greater than or equal to the Period End"
                                            ValidationGroup="vsumExpenses" ToolTip="The Period Start must be greater than or equal to the Period End"
                                            Text="*" EnableClientScript="false" OnServerValidate="custPeriod_ServerValidate"></asp:CustomValidator>
                                        <asp:CustomValidator ID="custPeriodLengthLimit" runat="server" EnableViewState="false"
                                            ValidationGroup="vsumExpenses" ErrorMessage="The period length must be not more then {0} months."
                                            ToolTip="The period length must be not more then {0} months." Text="*" EnableClientScript="false"
                                            OnServerValidate="custPeriodLengthLimit_ServerValidate"></asp:CustomValidator>
                                    </td>
                                    <td>
                                        <asp:Button ID="btnUpdate" runat="server" Text="Update View" OnClick="btnUpdate_Click"
                                            ValidationGroup="vsumExpenses" />
                                    </td>
                                </tr>
                            </table>
