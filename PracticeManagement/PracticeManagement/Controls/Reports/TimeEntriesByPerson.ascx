...
<div id="divPersonListSummary" runat="server">
    ...
    <div class="PersonGridLeftPadding divTeTable" runat="server" id="divTeTable">
        ...
        <asp:Repeater ID="repTeTable" runat="server" OnItemDataBound="repTeTable_OnItemDataBound"
            EnableViewState="false" OnItemCreated="repTeTable_OnItemCreated">
            <HeaderTemplate>
    ...
    <div class="PersonGridLeftPadding divProjects" runat="server" id="divProjects">
        ...
        <asp:Repeater ID="dlProjects" runat="server" EnableViewState="false" OnItemDataBound="dlProjects_OnItemDataBound">
            <ItemTemplate>
