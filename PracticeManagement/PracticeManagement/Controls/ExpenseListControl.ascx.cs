...
{
    public partial class ExpenseListControl : System.Web.UI.UserControl
    {
        #region Constants
        ...
        {
            HostingPage.Redirect(Constants.ApplicationPages.ExpenseDetail);
        }

        protected void btnExpenseCategories_Click(object sender, EventArgs e)
        {
            HostingPage.Redirect(Constants.ApplicationPages.ExpenseCategoryList);
        }

        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            Page.Validate(vsumExpenses.ValidationGroup);
            if (Page.IsValid)
            {
                Display();
            }
        ...
        {
            HostingPage.Redirect(string.Format(DetailsRedirect,
