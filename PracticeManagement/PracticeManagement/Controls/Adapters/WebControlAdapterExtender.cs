...
namespace PraticeManagement.Controls.Adapters
{
    public class WebControlAdapterExtender
    {
        ...
        public void RegisterScripts()
        {
			...
			// AdapterUtils.js
			string resource = "AdapterUtils.js";
			...
			if (String.IsNullOrEmpty(filePath))
			{
				...
				filePath = folderPath.EndsWith("/") ? folderPath + "AdapterUtils.js" : folderPath + "/TreeViewAdapter.js";
			}

			if (!AdaptedControl.Page.ClientScript.IsClientScriptIncludeRegistered(resource))
				AdaptedControl.Page.ClientScript.RegisterClientScriptInclude(resource, AdaptedControl.Page.ResolveUrl(filePath));
        }
