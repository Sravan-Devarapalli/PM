...
AjaxControlToolkit.CascadingDropDownBehavior.prototype = {
    initialize : function() {
        ...
        if (this._parentControlID) {
            ...
            if (!this._parentElement) {
                Sys.Debug.fail(String.format(AjaxControlToolkit.Resources.CascadingDropDown_NoParentElement, this._parentControlID));
            }
    ...
    set_SelectedValue : function(value, text, title) {
        ...
        AjaxControlToolkit.CascadingDropDownBehavior.callBaseMethod(this, 'set_ClientState', [ this._selectedValue+':::' + text+':::' + (title ? (':::' + title) : '') ]);
    },
...
//Sys.registerComponent(AjaxControlToolkit.CascadingDropDownBehavior, { name: "cascadingDropDown" });
