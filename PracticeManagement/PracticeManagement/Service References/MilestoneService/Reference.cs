...
namespace PraticeManagement.MilestoneService
{
    ...
    public interface IMilestoneService
    {
        ...
        [System.ServiceModel.OperationContractAttribute(Action = "http://tempuri.org/IMilestoneService/GetMonthlyExpensesByExpenseId", ReplyAction = "http://tempuri.org/IMilestoneService/GetMonthlyExpensesByExpenseIdResponse")]
        DataTransferObjects.PeriodicalExpense[] GetMonthlyExpensesByExpenseId(int expenseId);

        [System.ServiceModel.OperationContractAttribute(Action = "http://tempuri.org/IMilestoneService/SaveMonthlyExpenses", ReplyAction = "http://tempuri.org/IMilestoneService/SaveMonthlyExpensesResponse")]
        void SaveMonthlyExpenses(int expenseId, DataTransferObjects.PeriodicalExpense[] monthlyExpense);

        [System.ServiceModel.OperationContractAttribute(Action = "http://tempuri.org/IMilestoneService/SaveMonthlyRevenueForFixedMilestone", ReplyAction = "http://tempuri.org/IMilestoneService/SaveMonthlyRevenueForFixedMilestoneResponse")]
        void SaveMonthlyRevenueForFixedMilestone(int milestoneId, DataTransferObjects.MonthlyRevenue[] monthlyRevenues);

        [System.ServiceModel.OperationContractAttribute(Action = "http://tempuri.org/IMilestoneService/GetMonthlyRevenuesForMilestone", ReplyAction = "http://tempuri.org/IMilestoneService/GetMonthlyRevenuesForMilestoneResponse")]
        DataTransferObjects.MonthlyRevenue[] GetMonthlyRevenuesForMilestone(int milestoneId);

        [System.ServiceModel.OperationContractAttribute(Action = "http://tempuri.org/IMilestoneService/GetForecastDataForMilestone", ReplyAction = "http://tempuri.org/IMilestoneService/GetForecastDataForMilestoneResponse")]
        DataTransferObjects.Reports.PersonBudgetComparison[] GetForecastDataForMilestone(int milestoneId);
    }
    ...
    public partial class MilestoneServiceClient : System.ServiceModel.ClientBase<PraticeManagement.MilestoneService.IMilestoneService>, PraticeManagement.MilestoneService.IMilestoneService
    {
        ...
        public DataTransferObjects.PeriodicalExpense[] GetMonthlyExpensesByExpenseId(int expenseId)
        {
            return base.Channel.GetMonthlyExpensesByExpenseId(expenseId);
        }

        public void SaveMonthlyExpenses(int expenseId, DataTransferObjects.PeriodicalExpense[] monthlyExpense)
        {
            base.Channel.SaveMonthlyExpenses(expenseId, monthlyExpense);
        }

        public void SaveMonthlyRevenueForFixedMilestone(int milestoneId, DataTransferObjects.MonthlyRevenue[] monthlyRevenues)
        {
            base.Channel.SaveMonthlyRevenueForFixedMilestone(milestoneId, monthlyRevenues);
        }

        public DataTransferObjects.MonthlyRevenue[] GetMonthlyRevenuesForMilestone(int milestoneId)
        {
            return base.Channel.GetMonthlyRevenuesForMilestone(milestoneId);
        }

        public DataTransferObjects.Reports.PersonBudgetComparison[] GetForecastDataForMilestone(int milestoneId)
        {
            return base.Channel.GetForecastDataForMilestone(milestoneId);
        }
    }
}
