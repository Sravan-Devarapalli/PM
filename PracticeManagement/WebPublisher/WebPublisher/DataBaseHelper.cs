...
namespace WebPublisher
{
    public class DataBaseHelper
    {
        ...
        private void CreateDataBase(StringBuilder output)
        {
            ...
            createDbSample = createDbSample.Replace("%Sql_Data_Path%", SqlDataPath);
            /**/
            ...
            output.AppendFormat("Database File - {0}{1}", tmpFile, Environment.NewLine);
        ...
        private void BuildSript(string path, StringBuilder output, string dbName)
        {
            ...
            proc.StartInfo.Arguments += string.Format(" -i {0}", path.IndexOf(" ") > 0 ? string.Format("\"{0}\"", path) : path);
